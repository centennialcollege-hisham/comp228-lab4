...
public class StudentController implements Initializable {
    ...
    public void populateComboBox() {
        ...
        if (rbComputerScience.isSelected()) {
            ...
            cbCourses.getItems().addAll("Java", "Python", "C#", "Kotlin");

        } else {
            cbCourses.getItems().clear();
            cbCourses.getItems().addAll("Finance", "Project Management", "Technical Analysis", "Marketing");
    ...
    //to display a summary of all filled in / selected fields
